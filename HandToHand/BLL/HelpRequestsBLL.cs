...
namespace BLL
{
    public class HelpRequestsBLL
    {
        ...
        public bool AddHelpRequest(HelpRequestsDTO helpRequest)
        {
           return helpRequestsDAL.AddHelpRequest(HelpRequestsConverter.Map(helpRequest));
        }
        ...
        public List<VolunteeringForUsersDTO> GetVolunteersForHelpRequest(HelpRequest helpRequest)
        {
            ...
            return matchingVolunteers.ToList();
